...
function readQuery() {
  ...
  return {
    page: PAGE_IDS.includes(page) ? page : "D01",
    state: GLOBAL_STATES.includes(state) ? state : "normal",
    qa: params.get("qa") === "1",
  };
}
...
export function App() {
  ...
  return (
    <>
      ...
      <DesignInspector pageId={pageId} state={state} onPage={setPage} onState={setState} hidden={initial.qa} />
    </>
  );
}
