...
`2AF9C9FA308139DFF42F73501145279D012F95B445D43849B5554DDAF44039E1`
...
- `cancellation_reason` 为 trim 后 1–500 字符的纯文本；仅 cancelled 状态可非空，且 cancelled 状态必须非空。
